...
For webR graphics, there is a fallback bitmap device based on a WebAssembly build of the [Cairo](https://www.cairographics.org/) graphics library. This works well, but will be slower and invokes an additional resource download as the page is loaded.
