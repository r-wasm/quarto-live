...
display(HTML("<p>This is HTML output, and below is an image at full size.</p>"))
display(Image(filename='images/python-logo.png'))

display(HTML("<p>The same image as a retina rendering:</p>"))
Image(filename='images/python-logo.png', retina=True)
```
